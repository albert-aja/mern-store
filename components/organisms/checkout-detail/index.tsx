...
export default function checkoutDetail() {
  ...
  useEffect(() => {
    const localData = JSON.parse(localStorage.getItem("data-topup")!);
    setDataTopUp(localData);
  }, []);
  ...
  return (
    <>
      ...
      <div className="payment pt-md-50 pb-md-50 pt-10 pb-10">
        ...
        <p className="text-lg color-palette-1 mb-20">
          Your Account Name{" "}
          <span className="purchase-details">{dataTopUp.bankAccName}</span>
        </p>
        <p className="text-lg color-palette-1 mb-20">
          Type{" "}
        ...
        <p className="text-lg color-palette-1 mb-20">
          Bank Number{" "}
          <span className="payment-details">
            {dataTopUp.paymentItem.bank.noRek}
          </span>
        </p>
      </div>
    </>
